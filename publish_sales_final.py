...
try:
    ...
    repo.update_file(remote_path, "Fix sales page HTML encoding", content, existing.sha, branch=branch)
    print("updated sales page")
except Exception as e:
    print("creating sales page", e)
    repo.create_file(remote_path, "Publish Coinbase sales page", content, branch=branch)
