...
class BlofinClient:
    ...
    def set_leverage(self, inst_id: str, leverage: int, margin_mode: str = "isolated") -> dict:
        body = {
            "instId": inst_id,
    ...
    def place_order(
        ...
        if leverage is not None:
            try:
                self.set_leverage(inst_id, int(leverage), margin_mode=td_mode)
            except Exception as e:  # noqa: BLE001
                logger.warning("set_leverage %s lev=%s failed: %s", inst_id, leverage, e)
