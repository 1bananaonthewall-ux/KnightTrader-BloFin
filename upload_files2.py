...
def repo_latest_sha(full_name, branch="main"):
...
def upload_blob(full_name, path, blob_b64, message, base_sha=None, branch="main"):
...
def main():
    ...
    print("=== ppb tutorial branch + sha ===")
    ppb_branch, ppb_sha = repo_latest_sha("mknight2690-sys/Polly-Poly-Bot")
    print(ppb_branch, ppb_sha)

    print("=== ktc sales branch + sha ===")
    ktc_branch, ktc_sha = repo_latest_sha("mknight2690-sys/knighttrader-coinbase")
    print(ktc_branch, ktc_sha)
    ...
    r = upload_blob("mknight2690-sys/Polly-Poly-Bot", "docs/hermes-coinbase-setup.html",
                    ...
                    base_sha=None, branch=ppb_branch or "main")
    ...
    r = upload_blob("mknight2690-sys/knighttrader-coinbase", "hermes-setup-coinbase-buy.html",
                    ...
                    base_sha=None, branch=ktc_branch or "master")
    print(json.dumps(r, indent=2, ensure_ascii=False))
