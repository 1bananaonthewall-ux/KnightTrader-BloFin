...
print("raw first 80 chars:", raw[:80])
print("raw looks base64:", raw[:4] == "TVMF" or raw[:4] == "UEQg" or raw[:4] == "TVM=")

html = base64.b64decode(raw).decode("utf-8", "replace")
print("decoded len:", len(html))
print("decoded title:", html[html.find("<title>"):html.find("</title>") + 7])
