...
def main():
    ...
    ktc_file_sha = blob_sha_for_file_local("mknight2690-sys/knighttrader-coinbase", "hermes-setup-coinbase-buy.html", ktc_branch)
    print("ktc branch:", ktc_branch, "file sha:", ktc_file_sha)
...
def blob_sha_for_file_local(full_name, path, branch):
